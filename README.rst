...
.. image:: https://img.shields.io/travis/ClimateImpactLab/dalia.svg
        :target: https://travis-ci.org/ClimateImpactLab/dalia
...
.. image:: https://pyup.io/repos/github/ClimateImpactLab/dalia/shield.svg
     :target: https://pyup.io/repos/github/ClimateImpactLab/dalia/
     :alt: Updates
...
*Brewster Malevich: complete these instructions and then remove this section from
the readme.*
...
2.  Execute the following commands in this directory:
    ...
    .. code-block:: bash
        ...
        git remote add origin git@github.com:ClimateImpactLab/dalia.git
...
3.  Set up automated testing, coverage, updates, and docs:
    ...
    a.  Set up testing
        ...
        iii.    Flip the switch on ClimateImpactLab/dalia. If
        ...
        v.      Start writing tests for your code in the 
                ``dalia/tests`` folder. There are some
    ...
    b.  Set up docs
        ...
        iii.    click the '+' icon next to
                ClimateImpactLab/dalia. Pick a name for your
        ...
        v.      next time you push code to master, docs should build
                ...
                https://dalia.readthedocs.io/en/latest/
    ...
    c.  Set up updates
        ...
        iii.    Add ClimateImpactLab/dalia
